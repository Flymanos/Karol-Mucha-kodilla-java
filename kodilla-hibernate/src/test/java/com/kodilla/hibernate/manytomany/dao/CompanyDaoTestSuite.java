...
public class CompanyDaoTestSuite {
    ...
    public void testFindEmployeeByLastname(){
        ...
        employees.add(new Employee("Linda", "Kovalsky"));
    ...
    @Test
    public void testFindCompanyByFirstDigitsOfName(){
        //given
        List<Company> companies = new ArrayList<>();
        companies.add(new Company("Software Machine"));
        companies.add(new Company("Data Maesters"));
        companies.add(new Company("Grey Matter"));
